...
- (void) layoutSubControls
{
    ...
    imageView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"bg1"]];
...
- (void) prepareToTrainButtonClick:(UIButton *)button
{
    ...
    PTSpeed_HDetailVC *speed_HDetailVC = [PTSpeed_HDetailVC new];
    speed_HDetailVC.speed = difficult_speed;
    [self.navigationController pushViewController:speed_HDetailVC animated:YES];
}
