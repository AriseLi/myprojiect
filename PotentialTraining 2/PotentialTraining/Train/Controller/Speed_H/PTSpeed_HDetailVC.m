...
- (void) layoutSubControls
{
    ...
    CGFloat vMargin = (kScreenHeight - 64 - 100 - imageViewHeight * 5) / 4;
    ...
    secondImgV.frame = CGRectMake(kScreenWidth - imageViewWidth - 50, CGRectGetMaxY(firstImgV.frame) + vMargin, imageViewWidth, imageViewHeight);
    ...
    thirdImgV.frame = CGRectMake(CGRectGetMinX(firstImgV.frame), CGRectGetMaxY(secondImgV.frame) + vMargin, imageViewWidth, imageViewHeight);
    ...
    fourthImgV.frame = CGRectMake(CGRectGetMinX(secondImgV.frame), CGRectGetMaxY(thirdImgV.frame) + vMargin, imageViewWidth, imageViewHeight);
    ...
    fifthImgV.frame = CGRectMake(CGRectGetMinX(firstImgV.frame), CGRectGetMaxY(fourthImgV.frame) + vMargin, imageViewWidth, imageViewHeight);
